  ...
  return (
    ...
    >
      <DialogContent size="md">
        <DialogHeader title="Create New Maritime Group" variant="navy" />
        <form onSubmit={handleSubmit}>
          <DialogBody>
            <div className="create-group-form-fields">
              <div className="create-group-field-group">
                <label className="block text-sm font-bold text-[#0e2a4d]">Group Name</label>
                <input
                  type="text"
                  value={name}
              ...
              <div className="create-group-field-group">
                <label className="block text-sm font-bold text-[#0e2a4d]">Description</label>
                <textarea
                  value={description}
              ...
              <div className="create-group-field-group">
                <label className="block text-sm font-bold text-[#0e2a4d]">Privacy Setting</label>
                <select
                  value={type}
                ...
                <p className="text-[10px] text-gray-500 font-medium">Public groups are visible to everyone, while private groups require approval to join.</p>
              </div>
            </div>
          </DialogBody>
          <DialogFooter>
            <button
              ...
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 py-3 border border-gray-300 rounded-lg font-bold text-gray-600 hover:bg-gray-50 transition-all text-sm disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancel
            </button>
            <button
