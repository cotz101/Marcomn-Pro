...
export default function PersonalWalletPage() {
  ...
  return (
    <div className="wallet-page-root w-full font-sans pb-12 pt-4 sm:pt-6">
      {/* Navigation */}
      <Link
        href="/profile"
        ...
        <div className="lg:col-span-8">
          <div className="wallet-card-internal bg-white border border-gray-100 rounded-2xl shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 h-full">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-[#0e2a4d] leading-tight">Personal Wallet</h1>
                              ...
                              {tx.jobDetails ? (
                                <>
                                  <span className="text-xs font-bold text-slate-800 leading-snug">
                                    Job Acceptance Fee — {tx.jobDetails.title}
                                  </span>
              ...
              <div className="overflow-x-auto -mx-1 sm:mx-0">
                <table className="w-full text-left text-sm border-collapse min-w-[620px]">
                  <thead>
                    <tr className="border-b border-gray-100 text-gray-400 uppercase tracking-wider text-[11px] font-bold">
                      <th className="pb-3 pr-4 pl-1 w-[140px] min-w-[140px]">Date</th>
                      <th className="pb-3 px-3 w-[110px] min-w-[110px]">Amount</th>
                      <th className="pb-3 px-3 w-[120px] min-w-[120px]">Status</th>
                      <th className="pb-3 px-3">Remarks</th>
                      <th className="pb-3 pl-3 pr-4 text-right w-[120px] min-w-[120px]">Action</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100 text-gray-700 font-medium">
                    {topupRequests.map((req) => (
                      <tr key={req.id} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="py-3.5 px-3 font-bold text-sm text-[#0e2a4d] w-[110px] min-w-[110px] align-top">
                          +{Number(req.amount).toFixed(2)} MC
                        </td>
                        <td className="py-3.5 px-3 w-[120px] min-w-[120px] align-top">
                        ...
                        <td className="py-3.5 px-3 text-xs text-gray-500 leading-relaxed align-top">
                          {req.remarks || '—'}
                        </td>
                        <td className="py-3.5 pl-3 pr-4 text-right w-[120px] min-w-[120px] align-top">
                          {req.status === 'Approved' && (
